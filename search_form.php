...
<html lang = "en">
    ...
    <body>
        ...
        <div>
            <img src ="img/workout-img4.jpeg" id = "b-img" alt = "front-image">  
        </div>
        ...
        <div class = "row"  >
            ...
            <div class="container">
                <div class="row">
                    <h1 class="col-12 mt-4 mb-4" style="font-size:100px;">Workout Search Form</h1>
                </div> <!-- .row -->
            </div> <!-- .container -->
            <div class = "row">
                <div class = "col-1"> </div>
                <a href = "workoutpage.php" role="button" class="btn btn-primary" id ="back-button"> <i class="fa fa-fw fa-arrow-left"></i>Back to Main Page</a>
            </div>
            ...
            <div class="container mt-4">
                ...
                <form action="search_results.php" method="GET">
                    ...
                    <!-- Muscle name search -->
                    <div class="form-group row">
                        <label for="muscle-id" class="col-sm-3 col-form-label text-sm-right">Muscle:</label>
                        <div class="col-sm-9">
                    ...
                    <!-- Equipment used -->
                    <div class="form-group row">
                        <label for="equipment-id" class="col-sm-3 col-form-label text-sm-right">Equipment Used:</label>
                        <div class="col-sm-9">
                    ...
                    <!-- Difficult level -->
                    <div class="form-group row">
                        <label for="difficulty-id" class="col-sm-3 col-form-label text-sm-right">Difficulty Level:</label>
                        <div class="col-sm-9">
                    ...
                    <!-- Type of workout -->
                    <div class="form-group row">
                        <label for="type-id" class="col-sm-3 col-form-label text-sm-right">Type of Workout:</label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6 mt-2">
                            <button type="submit" class="btn btn-primary buttons"><i class="fa fa-fw fa-search"></i></button>
